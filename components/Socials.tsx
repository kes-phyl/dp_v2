...
const Socials = () => {
  return (
    ...
    <Link href='linkedin.com'>
        <FiLinkedin size={30} className="cursor-pointer hover:text-[#00c1f5] ease-in-out duration-300"/>
    </Link>
    <Link href='instagram.com'>
        <CiInstagram size={30} className="cursor-pointer hover:text-[#00c1f5] ease-in-out duration-300"/>
    </Link>
